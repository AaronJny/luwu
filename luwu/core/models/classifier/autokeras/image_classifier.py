...
# @FilePath     : /app/luwu/core/models/classifier/autokeras/image_classifier.py
# @Desc         :
"""
...
class LuWuAutoKerasImageClassifier(BaseLuWuModel):
    ...
    OPTIONS = [
        ...
        ModelWebInputOptions(
            name_cn="优化指标",
            name_en="objective",
            input_type=ModelWebInputSelectOptions(value=["val_loss", "val_accuracy"]),
            optional=True,
        ),
    ]
    ...
    def fit(
        ...
        **kwargs,
        ...
        self._model.fit(
            x, y, epochs, callbacks, validation_split, validation_data, **kwargs
        )
