...
<p>
  ...
  <img alt="Version" src="https://img.shields.io/badge/version-0.27-blue.svg?cacheSeconds=2592000" />
...
# 运行容器
docker run --name luwu -p 7788:7788 -v /home/xxx/data:/data aaronjny/luwu:latest
```
