...
<p>
  ...
  <img alt="Version" src="https://img.shields.io/badge/version-0.31-blue.svg?cacheSeconds=2592000" />
...
- [x] 架构和辅助功能
  ...
  - [x] 数据集组织方式
    - [x] 图像分类 
      ...
      - [ ] 以路径+类别的文本文件组织
    - [x] 文本分类
      - [x] [doccano](https://github.com/doccano/doccano)的导出格式
        - [ ] csv
        - [x] jsonl
    - [ ] 更多...
  - [x] 代码生成
  ...
  - [ ] 训练优化
    - [ ] EarlyStopping
    - [x] 迁移学习解冻特征抽取器做二次 Fine turn
    - [x] 自动样本均衡 (文本分类做了，图像分类还没做)
    - [ ] 增加简单的过拟合调节参数
  - [x] 命令行工具
    - [x] 图像分类任务的命令行支持
    - [x] 目标检测任务的命令行支持
